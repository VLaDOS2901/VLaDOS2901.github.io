...
<?php
$st = $_POST['name2'].";".$_POST['namel'].";".$_POST['nicl'].";".$_POST['email'].";".$_POST['password']."\n";

$fp=fopen("baza.txt","a");
$test = fwrite($fp,$st);
echo "<h2 align='center'>Ви ввели :".$_POST['name2'].",".$_POST['namel'].",".$_POST['nicl'].",".$_POST['email'].",".$_POST['password']."</h2>";
?>
</h1>
           </td>
        </tr>
        <tr>
			...
			<font size="4">Сайт розробив Влад</font>
			</td>
        </tr>
   </table>  
 </BODY>
